...
def view_post():
    ...
    if auth.user:
        ...
        form_edit_post = SQLFORM(db.post, id, showid=False, fields=['uc', 'category', 'title', 'body', 'image'], submit_button='Update').process(formname='edit_body_form', next='view_post/[id]')
