...
db.define_table('post',
                ...
                Field('draft', 'integer', default=0, writable=False, readable=False),
                auth.signature)
...
db.define_table('fav_post',
                # Each record references a specific post.
                Field('post', 'reference post'),
                Field('is_favourited', 'integer', default=0),
                auth.signature)
